def find_common_elements(list1, list2):
    ...
    # This is efficient for finding common elements
...
def find_user_by_name(users, name):
    ...
    """
    # Convert list to dictionary for O(1) lookup performance
    # Key is the user's name, value is the entire user dictionary
...
def get_list_of_even_numbers(numbers):
    ...
    """
    # Use list comprehension to filter even numbers while preserving order
